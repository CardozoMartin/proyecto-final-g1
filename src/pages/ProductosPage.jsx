        ...
        <div className="col-lg-9 col-md-8">
          ...
          <div className="d-flex justify-content-between align-items-center mb-4">
            <div>
              ...
              <small className="text-muted">Se encontraron 24 productos</small>
            </div>
            <div className="d-flex align-items-center">
              <label htmlFor="ordenar" className="form-label me-2 mb-0">Ordenar por:</label>
              <select className="form-select" id="ordenar" style={{width: 'auto'}}>
            ...
            <div className="col-xl-4 col-lg-6 col-md-6" key={index}>
              <div className="card h-100 shadow-sm">
                <div className="position-relative">
                  <img src={producto.imagen_producto || "error al cargar imagen"} 
                ...
                <div className="card-body d-flex flex-column">
                  ...
                  <p className="card-text text-muted">{producto.descripcion}</p>
                        <span className="h5 text-primary mb-0">${producto.precio_venta}</span>
