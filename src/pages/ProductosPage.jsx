...
const ProductosPage = () => {
  ...
  const productosFiltrados = productosActivos.filter((producto) => {
    ...
    if (nombreCategoria) {
      return (
        coincideBusqueda &&
        producto.nombreCategoriaProductos.toLowerCase() ===
  ...
  const handleAgregarAlCarrito = (producto) => {
    ...
    toast.success(
      `Producto ${productoQueSeAgrega.nombreProducto} agregado al carrito`
    );
          ...
          <div className="d-flex justify-content-center">
            <div className="row g-4" style={{ maxWidth: "1200px" }}>
              {productosFiltrados.map((producto, index) => (
                <div
                  className="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 d-flex justify-content-center"
                  key={index}
                >
                  <div
                  ...
                  >
                    ...
                    >
                      <img
                        src={
                          producto.imagenProducto || "error al cargar imagen"
                        }
